...
export interface Product {
  ...
  photos: (number | Media)[];
  /**
   * Optional short video of the article.
   */
  video?: (number | null) | Media;
  /**
   * Brand, measurements, flaws if any — whatever the buyer should know.
   */
  ...
  price: number;
  /**
   * Optional "was" price — shows a discount badge.
   */
...
/**
 * Your contact and payment details shown on every product page.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface StoreSetting {
  ...
  tagline?: string | null;
  /**
   * Scrolling bar at the very top of the site.
   */
  announcementText?: string | null;
  /**
   * Full link to your Instagram profile (optional).
   */
  instagramUrl?: string | null;
  /**
   * Big cover photo at the top of the homepage.
   */
  heroImage?: (number | null) | Media;
  /**
   * Optional second cover photo — the hero slowly cross-fades between the two.
   */
  ...
  /**
   * Account holder name shown to buyers.
   */
  easypaisaName?: string | null;
  /**
   * EasyPaisa account number shown to buyers.
   */
